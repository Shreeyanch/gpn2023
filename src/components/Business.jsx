...
const Business = () =>  (
  <section id="features" className={`${styles.flexCenter} ${styles.marginY} ${styles.padding} sm:flex-row flex-col bg-black-gradient-2 rounded-[20px] box-shadow`}>
    <div className={layout.sectionInfo}>
      ...
      Need to print <br className="sm:block hidden" /> but dont know how to start?
      </h2>
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
      Our hardworking creative staffs including imaginative designers and creative team with world class printing experince are available to guild you through!
      </p>
